...
export interface IRestaurantOrdersProps {
  orderStore?: OrderStore;
}

export interface IRestaurantOrdersState {
...
@observer
export class RestaurantOrders extends AppComponentBase<IRestaurantOrdersProps, IRestaurantOrdersState> {
  ...
  async updateOrdersList(maxResultCount: number, skipCount: number) {
    ...
    this.props.orderStore!.restaurantId = this.state.restaurantId;
    this.props.orderStore!.isFromRestaurants = true;
  ...
  ordersTableColumns = [
    ...
    },
    {
      ...
      key: 'restaurant',
      render:(restaurantName:string,item:OrderDto)=>{
